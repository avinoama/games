(function ($) {
  Drupal.behaviors.GamePieces = {
    attach: function (context, settings) {
      ...
      if(!patterns) {
        Drupal.settings.GamePieces.patterns = Array();
      }
    ...
    create_piece: function(params){
      ...
      if(Drupal.settings.GamePieces.piece_types[params.piece_type.type]==undefined) {
        Drupal.settings.GamePieces.piece_types[params.piece_type.type] = params.piece_type;
      }
      if(Drupal.settings.GamePieces.pieces[params.piece.id]==undefined) {
        Drupal.settings.GamePieces.pieces[params.piece.id] = params.piece;
      }
      for(i in params.patterns) {
        if(Drupal.settings.GamePieces.patterns[i]==undefined) {
          Drupal.settings.GamePieces.patterns[i] = params.patterns[i];
        }
      }
