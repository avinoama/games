(function ($) {
  Drupal.behaviors.RunningGame = {
    attach: function (context, settings) {
      ...
      //  Show Game Status
      Drupal.settings.RunningGame.conn = new WebSocket('ws://localhost:8080');
      Drupal.settings.RunningGame.conn.onopen = function(e) {
          console.log("Connection established!");
      };

      Drupal.settings.RunningGame.conn.onmessage = function(e) {
          console.log(e.data);
      };
